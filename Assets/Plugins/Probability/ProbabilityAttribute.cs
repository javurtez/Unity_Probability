...
{
    string errorMessage;
    ValueResolver<object[]> baseItemDataGetter;
    ...
    void DrawAll<T>(ValueResolver<T[]> inspectorPropertyValueGetter)
    {
    ...
    void DrawRange<T>(Rect rect, ValueResolver<T[]> inspectorPropertyValueGetter)
    {
        if (inspectorPropertyValueGetter.GetValue() != null && inspectorPropertyValueGetter.GetValue().Length != 0)
        {
    ...
    void DrawSelect<T>(Rect rect, ValueResolver<T[]> inspectorPropertyValueGetter)
    {
        if (inspectorPropertyValueGetter.GetValue() != null && inspectorPropertyValueGetter.GetValue().Length != 0)
        {
